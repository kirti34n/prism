...
```bash
pipx install prism-think          # recommended — 'prism' available everywhere
# or
...
<details>
<summary><b>Over time — <code>prism insights</code></b></summary>
...
Point the tool at this repo's [`skills/`](skills) folder — it's the open
...
A side project, built in free time — no plans to make it a product. The scope is
